...
# Details and more explanation coming soon!
...
breakout_subregion(gcamdataFolder = gcamdataFolderx,
                   ...
                   subregion = c("Bangkok",
                                 "Nonthaburi",
                                 "Samut Prakan"),
                   pop_projection = c(paste0(city_files_folder,"/pop_projection_thailand_bangkok.csv"),
                                      paste0(city_files_folder,"/pop_projection_thailand_nonthaburi.csv"),
                                      paste0(city_files_folder,"/pop_projection_thailand_samutprakan.csv")),
                   pcgdp_projection = c(paste0(city_files_folder,"/pcgdp_projection_thailand_bangkok.csv"),
                                        paste0(city_files_folder,"/pcgdp_projection_thailand_nonthaburi.csv"),
                                        paste0(city_files_folder,"/pcgdp_projection_thailand_samutprakan.csv")))
