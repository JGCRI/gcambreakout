...
"zchunk_L203.water_td_breakout.R", "5.4" ,"Error in left_join_error_no_match(., data_aggregated, by = c('region', : left_join_no_match: NA values in new data columns",
"zchunk_L133.water_demand_livestock_breakout.R", "5.4", "NaN values in L133.water_demand_livestock_R_B_W_km3 for Pork coefficient",
"zchunk_LB120.LC_GIS_R_LTgis_Yh_GLU_breakout.R", "5.4", "Error in left_join_error_no_match(., L123.LC_bm2_R_Past_Y_GLU, by = c('GCAM_region_ID',  : left_join_no_match: NA values in new data columns",
"zchunk_LB123.LC_R_MgdPastFor_Yh_GLU_breakout.R", "5.4","Error in left_join_error_no_match(., L123.LC_bm2_R_Past_Y_GLU, by = c('GCAM_region_ID',  : left_join_no_match: NA values in new data columns",
"zchunk_LA100.IEA_downscale_ctry_breakout.R", "5.4","Zero entries in electricity consumption of the commercial sector ('COMMPUB' product in the IEA Energy Balances)",
"zchunk_LB120.LC_GIS_R_LTgis_Yh_GLU_breakout.R", "5.4","Error in left_join_error_no_match(., L123.LC_bm2_R_Past_Y_GLU, by = c('GCAM_region_ID',  : left_join_no_match: NA values in new data columns",
"zchunk_LB123.LC_R_MgdPastFor_Yh_GLU_breakout.R", "5.4","Error in left_join_error_no_match(., L123.LC_bm2_R_Past_Y_GLU, by = c('GCAM_region_ID',  : left_join_no_match: NA values in new data columns",
...
"zchunk_L241.fgas_breakout.R","5.4","Missing regions in hfc_all, pfc_all"
) %>%
...
# template_zchunk_L241.fgas_breakout
template_zchunk_L241.fgas_breakout <- readr::read_lines(paste0(dataFileFolder,"/zchunk_L241.fgas_breakout.R"))
use_data(template_zchunk_L241.fgas_breakout,version=3, overwrite=T)
