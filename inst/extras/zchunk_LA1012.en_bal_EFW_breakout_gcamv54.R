...
module_energy_LA1012.en_bal_EFW <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    ### SRSds, 02Sep21: Broken countries in Middle East such as Lebanon, Kuwait and Israel have unreasonably high estimates of deduction_EJ,
    # likely due to the quality of the input data. In the absence of higher-quality data, these high estimates are reduced below to avoid
