...
"zchunk_LA111.rsrc_fos_Prod_breakout_gcamv60.R", "6.0","R",".R", "modification for Uruguay (regions with no historical rsrc production)",
"zchunk_LA120.offshore_wind_breakout_gcamv60.R", "6.0","R",".R","Error in left_join_error_no_match(., L120.grid.cost %>% select(region, : left_join_no_match: NA values in new data columns",
"zchunk_LA1012.en_bal_EFW_breakout_gcamv60.R", "6.0","R",".R", 'Error in left_join_error_no_match(., L120.mid.price, by = c("GCAM_region_ID")) : left_join_no_match: NA values in new data columns',
"zchunk_LA1321.cement_breakout_gcamv60.R", "6.0","R",".R","NAs in xml cement.xml",
...
"zchunk_LB123.LC_R_MgdPastFor_Yh_GLU_breakout_gcamv60.R", "6.0","R",".R","Error in left_join_error_no_match(., L123.LC_bm2_R_Past_Y_GLU, by = c('GCAM_region_ID',  : left_join_no_match: NA values in new data columns",
"zchunk_LB142.ag_Fert_IO_R_C_Y_GLU_breakout_gcamv60.R", "6.0","R",".R",'Error in module_aglu_LB142.ag_Fert_IO_R_C_Y_GLU("MAKE", list(`common/iso_GCAM_regID` = list( : Fertilizer input-output coefficients need to be specified in all historical years',
"zchunk_LB171.LC_R_Cropland_Yh_GLU_irr_breakout_gcamv6p0.R","6.0","R",".R","gcamdata: GLU GCAM_region_ID",
"zchunk_LB1321.regional_ag_prices_breakout_gcamv60.R", "6.0","R",".R","NAs in xml en_supply.xml",
...
"zchunk_L171.desalination_breakout_gcamv60.R", "6.0","R",".R","Error in left_join_error_no_match(., L123.LC_bm2_R_Past_Y_GLU, by = c('GCAM_region_ID',  : left_join_no_match: NA values in new data columns",
