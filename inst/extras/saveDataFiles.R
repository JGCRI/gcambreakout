...
template_zchunk_batch_hydrogen_xml_breakout_gcamv6p0 <- readr::read_lines(paste0(dataFileFolder,"/zchunk_batch_hydrogen_xml_breakout_gcamv6p0.R"))
use_data(template_zchunk_batch_hydrogen_xml_breakout_gcamv6p0,version=3, overwrite=T)
