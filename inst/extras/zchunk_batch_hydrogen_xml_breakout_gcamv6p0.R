...
module_energy_batch_hydrogen_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    #........................
    # gcambreakout 23 Jan 2023
    # Edits to fix "Called for price of non-existant market trn_freight_road in region Malaysia"
    #........................

    L225.GlobalTechCoef_h2 %>%
      dplyr::filter(!(sector.name == "H2 liquid truck" & minicam.energy.input=="trn_freight_road")) -> L225.GlobalTechCoef_h2
    L225.GlobalTechInputPMult_h2 %>%
      dplyr::filter(!(sector.name == "H2 liquid truck" & minicam.energy.input=="trn_freight_road")) -> L225.GlobalTechInputPMult_h2
