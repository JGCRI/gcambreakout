  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    select(IrrRfdCropland, GCAM_region_ID, GCAM_commodity, GCAM_subsector, GLU, year,
      ...
      add_precursors("L122.LC_bm2_R_HarvCropLand_C_Yh_GLU",
                     "L161.ag_irrHA_frac_R_C_GLU","common/iso_GCAM_regID","water/basin_to_country_mapping") ->
    ...
    select(ecyield.both, GCAM_region_ID, GCAM_commodity, GCAM_subsector, GLU, year, value =
      ...
      add_precursors("L161.ag_irrProd_Mt_R_C_Y_GLU","common/iso_GCAM_regID","water/basin_to_country_mapping") ->
      L171.ag_irrEcYield_kgm2_R_C_Y_GLU
    ...
    select(ecyield.both, GCAM_region_ID, GCAM_commodity, GCAM_subsector, GLU, year, value =
      ...
      add_precursors("L161.ag_rfdProd_Mt_R_C_Y_GLU","common/iso_GCAM_regID","water/basin_to_country_mapping") ->
      L171.ag_rfdEcYield_kgm2_R_C_Y_GLU
