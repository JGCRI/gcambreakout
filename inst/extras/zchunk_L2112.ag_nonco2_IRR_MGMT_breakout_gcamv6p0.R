...
module_emissions_L2112.ag_nonco2_IRR_MGMT <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L2112.AGRBio %>%
      ...
      add_precursors("L2111.AGRBio","common/iso_GCAM_regID","water/basin_to_country_mapping",
    ...
    L2112.AGREmissions %>%
      ...
      add_precursors("L2111.AGREmissions", "L2012.AgProduction_ag_irr_mgmt",
                     "common/iso_GCAM_regID","water/basin_to_country_mapping","common/GCAM_region_names") ->
      L2112.AGREmissions
