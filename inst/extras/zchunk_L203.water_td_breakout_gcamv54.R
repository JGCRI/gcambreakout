...
module_water_L203.water_td <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    #### SRSdS, 12Aug21: Check for NA values and replace them by 0 in case they are found
    L133.water_demand_livestock_R_B_W_km3[is.na(L133.water_demand_livestock_R_B_W_km3)] = 0
